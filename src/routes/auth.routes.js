...
import { register, login, logout, protectedRoute, register_OFSC_SuperAdmin, register_OFSC_SubAdmin, forgotPassword, resetPassword, updateProfile, resendResetOTP } from '../controllers/auth.controller.js';
