...
abstract class FlutterFlowTheme {
  ...
  late Color rejected;
  late Color isseued;
  late Color shadowCLr;
  late Color redTrans;
  late Color greenTrans;
  late Color yellowTrans;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color pending = const Color(0xFFFFA726);
  late Color approved = const Color(0xFF81C784);
  late Color rejected = const Color(0xFFEF5350);
  late Color isseued = const Color(0xFF42A5F5);
  late Color shadowCLr = const Color(0xFFF2F2F2);
  late Color redTrans = const Color(0x62FF5963);
  late Color greenTrans = const Color(0xFFE8F5E8);
  late Color yellowTrans = const Color(0xFFFFF8E1);
}
