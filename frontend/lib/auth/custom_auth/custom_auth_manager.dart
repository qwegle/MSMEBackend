...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    msmeAuthUserSubject.add(
      MsmeAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MsmeAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MsmeAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MsmeAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    msmeAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
