...
import '/index.dart';
import 'exsiting_loan_application_status_admin_widget.dart'
    show ExsitingLoanApplicationStatusAdminWidget;
import 'package:flutter/material.dart';

class ExsitingLoanApplicationStatusAdminModel
    extends FlutterFlowModel<ExsitingLoanApplicationStatusAdminWidget> {
  ...
  String? _loansearch1TextControllerValidator(
    ...
    if (val.length < 6) {
      return FFLocalizations.of(context).getText(
        'q6wmuiky' /* Enter full 6-character loan nu... */,
      );
    }
