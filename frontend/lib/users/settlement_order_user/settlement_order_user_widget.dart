...
import 'settlement_order_user_model.dart';
export 'settlement_order_user_model.dart';

class SettlementOrderUserWidget extends StatefulWidget {
  const SettlementOrderUserWidget({super.key});

  static String routeName = 'SettlementOrderUser';
  static String routePath = '/osfc-user-settlementorder';

  @override
  State<SettlementOrderUserWidget> createState() =>
      _SettlementOrderUserWidgetState();
}

class _SettlementOrderUserWidgetState extends State<SettlementOrderUserWidget> {
  late SettlementOrderUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettlementOrderUserModel());
              ...
              if (responsiveVisibility(
                ...
                wrapWithModel(
                  ...
                  child: MainwebnavOsfcUserWidget(
                    ...
                    clr8: FlutterFlowTheme.of(context).secondaryText,
                    backColor5: Color(0xFFDDFFFE),
                  ),
                ),
              if (responsiveVisibility(
                context: context,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Builder(
                                                                            builder:
                                                                                (context) {
                                                                              final settelmentOrder = getJsonField(
                                                                                FFAppState().SettOrderReff,
                                                                                r'''$.paginatedData''',
                                                                              ).toList();
                                                                              if (settelmentOrder.isEmpty) {
                                                                                return Center(
                                                                                  child: Image.asset(
                                                                              ...
                                                                              return ListView.builder(
                                                                                ...
                                                                                itemCount: settelmentOrder.length,
                                                                                itemBuilder: (context, settelmentOrderIndex) {
                                                                                  final settelmentOrderItem = settelmentOrder[settelmentOrderIndex];
                                                                                  return Padding(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          FlutterFlowIconButton(
                                                                                                            ...
                                                                                                            onPressed: () async {
                                                                                                              ...
                                                                                                              context.pushNamed(
                                                                                                                ViewUserDetailsWidget.routeName,
                                                                                                          ...
                                                                                                          FlutterFlowIconButton(
                                                                                                            ...
                                                                                                            onPressed: () async {
                                                                                                              _model.userReffDetailsView2 = await MsmeOsfcGroup.trackApplicationStatusCall.call(
                                                                                                              ...
                                                                                                              FFAppState().TrackStatusOSFC = getJsonField(
                                                                                                                (_model.userReffDetailsView2?.jsonBody ?? ''),
                                                                                                                r'''$''',
                                                                                                              );
                                                                                                              safeSetState(() {});

                                                                                                              context.pushNamed(
                                                                                                                TrackOtsFormStatusFlowWidget.routeName,
                                                                                                                extra: <String, dynamic>{
                                                                                                                  kTransitionInfoKey: TransitionInfo(
                                                                                                                    hasTransition: true,
                                                                                                                    transitionType: PageTransitionType.fade,
