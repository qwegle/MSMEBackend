...
import 'acknowledgement_slip_user_model.dart';
export 'acknowledgement_slip_user_model.dart';

class AcknowledgementSlipUserWidget extends StatefulWidget {
  const AcknowledgementSlipUserWidget({super.key});

  static String routeName = 'AcknowledgementSlipUser';
  static String routePath = '/osfc-user-acknowledgementslip';

  @override
  State<AcknowledgementSlipUserWidget> createState() =>
      _AcknowledgementSlipUserWidgetState();
}

class _AcknowledgementSlipUserWidgetState
    extends State<AcknowledgementSlipUserWidget> {
  late AcknowledgementSlipUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcknowledgementSlipUserModel());
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: Row(
                                                                                  ...
                                                                                  children: [
                                                                                                        ...
                                                                                                        child: TextFormField(
                                                                                                          ...
                                                                                                          decoration: InputDecoration(
                                                                                                            ...
                                                                                                            hintText: FFLocalizations.of(context).getText(
                                                                                                              '0zm2acjo' /* Search your loan number... */,
                                                                                                            ),
                                                                                    ...
                                                                                    FFButtonWidget(
                                                                                      onPressed: () async {
                                                                                        _model.formvslidate = true;
                                                                                        if (_model.formKey.currentState == null || !_model.formKey.currentState!.validate()) {
                                                                                          safeSetState(() => _model.formvslidate = false);
                                                                                          return;
                                                                                        }
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () async {
                                                                            _model.apiAckLAst =
                                                                                await MsmeOsfcGroup.filterAckFormsCall.call(
                                                                              authToken: currentAuthenticationToken,
                                                                              limit: valueOrDefault<String>(
                                                                                _model.limitDropDownValue,
                                                                                '0',
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'hneswae5' /* Update your profile and how pe... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '2erkp43i' /* Looking for info about us? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '8qpwcotk' /* Tips on how to use Pandora? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
