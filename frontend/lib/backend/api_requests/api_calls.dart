...
class OpenStockCreateCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/openingstock/create',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
...
class ClaimDocumentsFormICall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/claimdocuments/createForm1',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
...
class ClaimDocumentsFormVCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/claimdocuments/createFormV',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
...
class ClaimDocumentsFormVICall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/claimdocuments/createFormVI',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
...
class ClaimDocumentsDeclarationCertificateCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/claimdocuments/createDeclarationCertificate',
      callType: ApiCallType.GET,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
...
class ClaimDocumentsAuditCertificateCall {
  Future<ApiCallResponse> call({
    ...
    return ApiManager.instance.makeApiCall(
      ...
      apiUrl: '${baseUrl}/api/OKVI/claimdocuments/uploadAuditCertificate',
      callType: ApiCallType.POST,
      headers: {
        'Authorization': 'Bearer ${authToken}',
      },
