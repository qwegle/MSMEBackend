...
import { Eye, Trash2, Search, PackageCheck } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="page-header">
        ...
        <p className={`page-subtitle ${language === 'or' ? 'font-odia' : ''}`}>
          {t('stock:closingStockListDesc', { defaultValue: 'View and manage your submitted closing stock entries' })}
        </p>
      </div>
      ...
      <div className="dashboard-card">
        <div className="dashboard-card-header">
          <div className="dashboard-card-title">
            <PackageCheck size={20} className="text-gov-green" />
        ...
        <div className="p-0">
          {loading ? (
            <div className="flex items-center justify-center py-16">
              <div className="animate-spin rounded-full h-8 w-8 border-2 border-gov-green border-t-transparent"></div>
            </div>
            ...
            <div className="empty-state">
              ...
              <p className={`empty-state-text ${language === 'or' ? 'font-odia' : ''}`}>
                {t('stock:noClosingStockEntriesDesc', { defaultValue: 'No closing stock entries found.' })}
              </p>
            </div>
          ) : (
            <table className="data-table">
              <thead>
                <tr>
                  ...
                  <th className={language === 'or' ? 'font-odia' : ''}>{t('stock:spellEndDate')}</th>
              ...
              <tbody>
                {filteredStocks.map((stock, index) => (
                  <tr key={stock._id}>
                    ...
                    <td>{formatDate(stock.festival?.spellEndDate)}</td>
                    <td className="font-semibold text-gov-green">₹{stock.totalAmount?.toLocaleString() || 0}</td>
                    ...
                    <td>
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-2 text-gov-green hover:bg-gov-green/10 rounded-lg transition-colors"
                          title="View Details"
                        >
                          <Eye size={18} />
                        </button>
      ...
      <Modal
        ...
        title={t('stock:viewClosingStock', { defaultValue: 'View Closing Stock' })}
        size="lg"
      >
        {selectedStock && (
          <div className="space-y-6">
              ...
              <table className="data-table">
                ...
                <tfoot>
                  <tr className="bg-gov-green/5">
                    ...
                    <td className="font-bold text-gov-green text-lg">
