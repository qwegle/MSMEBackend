...
import '/index.dart';
import 'dashboard_user_widget.dart' show DashboardUserWidget;
import 'package:flutter/material.dart';

class DashboardUserModel extends FlutterFlowModel<DashboardUserWidget> {
  ...
  // Stores action output result for [Backend Call - API (User Stats)] action in DashboardUser widget.
  ApiCallResponse? apiUserCount12;
