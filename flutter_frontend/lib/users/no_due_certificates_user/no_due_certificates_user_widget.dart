...
import 'no_due_certificates_user_model.dart';
export 'no_due_certificates_user_model.dart';

class NoDueCertificatesUserWidget extends StatefulWidget {
  const NoDueCertificatesUserWidget({super.key});

  static String routeName = 'NoDueCertificatesUser';
  static String routePath = '/osfc-user-no-due-certificates';

  @override
  State<NoDueCertificatesUserWidget> createState() =>
      _NoDueCertificatesUserWidgetState();
}

class _NoDueCertificatesUserWidgetState
    extends State<NoDueCertificatesUserWidget> {
  late NoDueCertificatesUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NoDueCertificatesUserModel());
                                                                            ...
                                                                            children:
                                                                                                  ...
                                                                                                  child: TextFormField(
                                                                                                    ...
                                                                                                    decoration: InputDecoration(
                                                                                                      ...
                                                                                                      hintText: FFLocalizations.of(context).getText(
                                                                                                        'd5kyp9r2' /* Search your loan number... */,
                                                                                                      ),
                                                                              ...
                                                                              FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  ...
                                                                                  _model.apiNDCFilterUser = await MsmeOsfcGroup.filterCertificatesCall.call(
                                                                                  ...
                                                                                  if ((_model.apiNDCFilterUser?.succeeded ?? true)) {
                                                                                    FFAppState().NDCFilter = getJsonField(
                                                                                      (_model.apiNDCFilterUser?.jsonBody ?? ''),
                                                                                      r'''$''',
                                                                                    );
                                                                                    safeSetState(() {});
                                                                                  }
                                                                              ...
                                                                              FFButtonWidget(
                                                                                onPressed: () async {
                                                                                  _model.apiNDCFilterResetUser = await MsmeOsfcGroup.filterCertificatesCall.call(
                                                                                    authToken: currentAuthenticationToken,
                                                                                    userId: getJsonField(
                                                                                      FFAppState().userReff,
                                                                                      r'''$.user.id''',
                                                                                  ...
                                                                                  FFAppState().NDCFilter = getJsonField(
                                                                                    (_model.apiNDCFilterResetUser?.jsonBody ?? ''),
                                                                                    r'''$''',
                                                                                  );
                                                                                  safeSetState(() {});
                                                                    ...
                                                                    child: FlutterFlowDropDown<
                                                                      ...
                                                                      onChanged:
                                                                        ...
                                                                        safeSetState(() =>
                                                                            _model.limitDropDownValue =
                                                                                val);
                                                                        _model.apiCertificateLimitChange = await MsmeOsfcGroup
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        _model.apiCertificateFirst = await MsmeOsfcGroup
                                                                            .filterCertificatesCall
                                                                            .call(
                                                                          authToken:
                                                                              currentAuthenticationToken,
                                                                    ...
                                                                    InkWell(
                                                                      ...
                                                                      onTap:
                                                                        ...
                                                                        if (getJsonField(
                                                                            ...
                                                                            null) {
                                                                          _model.apiCertificatePrevious = await MsmeOsfcGroup
                                                                              .filterCertificatesCall
                                                                              .call(
                                                                            authToken:
                                                                                currentAuthenticationToken,
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (getJsonField(
                                                                          ...
                                                                          null) {
                                                                        _model.apiCertificateNext = await MsmeOsfcGroup
                                                                            .filterCertificatesCall
                                                                            .call(
                                                                          authToken:
                                                                              currentAuthenticationToken,
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      _model.apiCertificateLast = await MsmeOsfcGroup
                                                                          .filterCertificatesCall
                                                                          .call(
                                                                        authToken:
                                                                            currentAuthenticationToken,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          '3myx2lgc' /* Update your profile and how pe... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'sicnfmy0' /* Looking for info about us? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '0cj8umsw' /* Tips on how to use Pandora? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
