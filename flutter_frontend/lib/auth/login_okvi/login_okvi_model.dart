...
class LoginOkviModel extends FlutterFlowModel<LoginOkviWidget> {
  ...
  // Stores action output result for [Backend Call - API (Dashboard User)] action in btn_login widget.
  ApiCallResponse? getDashboardUser;
  // Stores action output result for [Backend Call - API (Get Claim Data)] action in btn_login widget.
  ApiCallResponse? getClaimsDataUser;
  // Stores action output result for [Backend Call - API (Get Claim Header)] action in btn_login widget.
  ApiCallResponse? apiGetClaimHeader;
  // Stores action output result for [Backend Call - API (Admin dashboard with statistics)] action in btn_login widget.
  ApiCallResponse? getAllHolidaysAdmin;
  // Stores action output result for [Backend Call - API (Get Claim Data)] action in btn_login widget.
  ApiCallResponse? getClaimsData;
  // Stores action output result for [Backend Call - API (Get Claim Header)] action in btn_login widget.
  ApiCallResponse? apiGetClaimHeaderAdmin;
