...
import 'login_okvi_model.dart';
export 'login_okvi_model.dart';

class LoginOkviWidget extends StatefulWidget {
  const LoginOkviWidget({super.key});

  static String routeName = 'LoginOkvi';
  static String routePath = '/login-okvi';

  @override
  State<LoginOkviWidget> createState() => _LoginOkviWidgetState();
}

class _LoginOkviWidgetState extends State<LoginOkviWidget> {
  late LoginOkviModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LoginOkviModel());
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'dq4nyfg5' /* Shri Mohan Charan Majhi */,
                                                            ),
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'uz6p984w' /* Hon’ble Chief Minister of Odis... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .titleMedium
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'v1ili4v3' /* Micro, Small & Medium Enterpri... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .displayMedium
                                                        ...
                                                        Flexible(
                                                          child: Text(
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '12ve5xwe' /* Micro, Small & Medium Enterpri... */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .displayMedium
                                                      ...
                                                      children: [
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'rjx9eha5' /* Welcome! Sign in to your accou... */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child:
                                                                  ...
                                                                  focusNode: _model
                                                                      .entercaptchaTextFieldFocusNode,
                                                                  autofocus:
                                                                      false,
                                                                  obscureText:
                                                                      false,
                                                                ...
                                                                await showDialog(
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    return AlertDialog(
                                                                      ...
                                                                      content: Text(
                                                                          ' No user role available for your account. Please contact support.'),
                                                                      actions: [
                                                                        TextButton(
                                                                          onPressed: () =>
                                                                    ...
                                                                    children: [
                                                                      TextSpan(
                                                                        text: FFLocalizations.of(context)
                                                                            .getText(
                                                                          'y9rsz2wq' /* Don’t have any acount?   */,
                                                                        ),
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .labelMedium
                                                                            .override(
                                                            ...
                                                            Expanded(
                                                              child:
                                                                ...
                                                                text: FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '7ywoqma5' /* Industries Registration */,
                                                                ),
                                                                options:
                                                                    FFButtonOptions(
                                                                  height: 50.0,
