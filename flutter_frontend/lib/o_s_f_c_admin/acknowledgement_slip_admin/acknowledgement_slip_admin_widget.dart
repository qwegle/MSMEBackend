...
import 'acknowledgement_slip_admin_model.dart';
export 'acknowledgement_slip_admin_model.dart';

class AcknowledgementSlipAdminWidget extends StatefulWidget {
  const AcknowledgementSlipAdminWidget({super.key});

  static String routeName = 'AcknowledgementSlipAdmin';
  static String routePath = '/osfc-admin-acknowledgement';

  @override
  State<AcknowledgementSlipAdminWidget> createState() =>
      _AcknowledgementSlipAdminWidgetState();
}

class _AcknowledgementSlipAdminWidgetState
    extends State<AcknowledgementSlipAdminWidget> {
  late AcknowledgementSlipAdminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AcknowledgementSlipAdminModel());
                      ...
                      if (responsiveVisibility(
                        ...
                        wrapWithModel(
                          ...
                          child: MainwebnavOsfcAdminWidget(
                            clr3: FlutterFlowTheme.of(context).primary,
                          ),
                        ),
                      Expanded(
                        child: Column(
                                                                                                ...
                                                                                                child: TextFormField(
                                                                                                  ...
                                                                                                  decoration: InputDecoration(
                                                                                                    ...
                                                                                                    hintText: FFLocalizations.of(context).getText(
                                                                                                      'jh01pics' /* Search your loan number... */,
                                                                                                    ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onChanged:
                                                                      ...
                                                                      safeSetState(() =>
                                                                          _model.limitDropDownValue =
                                                                              val);
                                                                      _model.apiAckLimitChange = await MsmeOsfcGroup
                                                                          .filterAckFormsCall
                                                                          .call(
                                                                        authToken:
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      _model.apiAckFirst = await MsmeOsfcGroup
                                                                          .filterAckFormsCall
                                                                          .call(
                                                                        authToken:
                                                                            currentAuthenticationToken,
                                                                  ...
                                                                  InkWell(
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (getJsonField(
                                                                          ...
                                                                          null) {
                                                                        _model.apiAckprevious = await MsmeOsfcGroup
                                                                            .filterAckFormsCall
                                                                            .call(
                                                                          authToken:
                                                                              currentAuthenticationToken,
                                                                ...
                                                                InkWell(
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    if (getJsonField(
                                                                        ...
                                                                        null) {
                                                                      _model.apiAckNext = await MsmeOsfcGroup
                                                                          .filterAckFormsCall
                                                                          .call(
                                                                        authToken:
                                                                            currentAuthenticationToken,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'zlv24z0v' /* Update your profile and how pe... */,
                                                        ),
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '202fc4a0' /* Looking for info about us? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                            ...
                                                            children: [
                                                              Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'd9vdgvm4' /* Tips on how to use Pandora? */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
