...
import '/index.dart';
import 'form_vi_widget.dart' show FormViWidget;
import 'package:flutter/material.dart';

class FormViModel extends FlutterFlowModel<FormViWidget> {
  ///  State fields for stateful widgets in this page.

  // Model for MainwebnavOkvi component.
  late MainwebnavOkviModel mainwebnavOkviModel;
  DateTime? datePicked;
  // Stores action output result for [Backend Call - API (Claim Documents Form VI)] action in Button widget.
