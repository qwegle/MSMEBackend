...
import '/index.dart';
import 'admin_documents_widget.dart' show AdminDocumentsWidget;
import 'package:flutter/material.dart';

class AdminDocumentsModel extends FlutterFlowModel<AdminDocumentsWidget> {
  ///  State fields for stateful widgets in this page.

  // Model for MainwebnavOkviAdmin component.
  late MainwebnavOkviAdminModel mainwebnavOkviAdminModel;
  // Stores action output result for [Backend Call - API (Get Claim Data)] action in IconButton widget.
  ApiCallResponse? aPIClaimIdData;
