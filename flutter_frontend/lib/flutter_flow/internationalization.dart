...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // master-data
  {
    ...
    '45atc0v2': {
      'en': 'Enter Head Name is required',
      'or': '',
    },
    '5pim6p5e': {
      'en': 'Please choose an option from the dropdown',
  ...
  // FormI
  {
    ...
    'ainwvo0r': {
      'en': 'Sub Center Address:',
      'or': 'ମହୋତ୍ସବର ନାମ:',
    },
    '73jk37tc': {
      'en': 'Enter Sub Center Address',
      'or': '',
    },
    '34mji6fh': {
      'en': 'Date *',
  ...
  // DeclarationCertificate
  {
    ...
    '5w9z92vq': {
      'en':
          'I Certify:-\n\n(i) That the benifit of the subsidy on weaving wages and processing cost received from the Director of Industries, Odisha will be passed on to the customers.\n\n\n(ii) That no incentive wages has been taken into account in claiming the subsidy.\n\n\n(iii) That the claim is correct and made according to rules and conditions prescribes by the MSME dept. Govt. of Odisha.\n\n\n(iv) That the claims are strictly according to the books of the account of the institution and that the amount of the claims has not been claimed and received previously and in the event of any amount is to have been over paid as a result of security of initial accounts event the auditors of the Directorate of Industries or by the statutory audit, the institution promptly repay such amounts to the Directorate of Industries.\n\n\n(v) That we shall produce all the books of accounts, cash memo, vouchers and necessary records for inspection to the auditor’s or other representative of the commission and/ or the audit department of the Govt. of India / Govt. of Odisha when demanded.',
      'or':
          'କୌଣସି ଷ୍ଟକ୍ ଏଣ୍ଟ୍ରି ମିଳିଲା ନାହିଁ। ଉପରେ ଆପଣଙ୍କର ପ୍ରଥମ ଏଣ୍ଟ୍ରି ଯୋଡନ୍ତୁ।',
    },
    'cqk0x07f': {
      'en': 'I Agree to the Declaration',
      'or': 'ଦାଖଲ କରନ୍ତୁ',
    },
    'a73x6c44': {
      'en': 'Cancel',
  ...
  // AuditCertificate
  {
    ...
    'rye0wy1p': {
      'en': 'Upload Audit Certificate From Chartered Accountant *',
      'or': 'ପର୍ବ ନାମ *',
    },
    'yb02l67x': {
      'en': 'Upload File',
  ...
  // ProofOfBankDeposit
  {
    ...
    '40po6j2q': {
      'en': 'Upload Proof of Bank Deposit of Sale Proceeds *',
      'or': 'ପର୍ବ ନାମ *',
    },
    'f7g073jz': {
      'en': 'Upload File',
  ...
  // viewUserDocuments
  {
    ...
    'tkg6u86w': {
      'en': 'Form - V : Sales And Rebate Details',
      'or': 'ଅନ୍ତିମ ଦାଖଲ ଡକ୍ୟୁମେଣ୍ଟ ତାଲିକା',
    },
    'gsktx1vq': {
      'en': 'Head',
    ...
    '7d5bltec': {
      'en': 'Form - VI : Sales And Rebate Details',
      'or': 'ଅନ୍ତିମ ଦାଖଲ ଡକ୍ୟୁମେଣ୍ଟ ତାଲିକା',
    },
    'cgyc6tix': {
      'en': 'Sub-Center',
