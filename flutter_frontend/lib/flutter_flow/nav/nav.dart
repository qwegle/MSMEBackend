...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: MasterDataWidget.routeName,
          path: MasterDataWidget.routePath,
          builder: (context, params) => MasterDataWidget(),
        ),
        FFRoute(
          name: DashboardOkviAdminWidget.routeName,
          path: DashboardOkviAdminWidget.routePath,
          builder: (context, params) => DashboardOkviAdminWidget(),
        ),
        FFRoute(
          name: AdminDocumentsWidget.routeName,
          path: AdminDocumentsWidget.routePath,
          builder: (context, params) => AdminDocumentsWidget(),
        ),
        FFRoute(
          name: FormIWidget.routeName,
          path: FormIWidget.routePath,
          builder: (context, params) => FormIWidget(),
        ),
        FFRoute(
          name: FormVWidget.routeName,
          path: FormVWidget.routePath,
          builder: (context, params) => FormVWidget(),
        ),
        FFRoute(
          name: FormViWidget.routeName,
          path: FormViWidget.routePath,
          builder: (context, params) => FormViWidget(),
        ),
        FFRoute(
          name: DeclarationCertificateWidget.routeName,
          path: DeclarationCertificateWidget.routePath,
          builder: (context, params) => DeclarationCertificateWidget(),
        ),
        FFRoute(
          name: AuditCertificateWidget.routeName,
          path: AuditCertificateWidget.routePath,
          builder: (context, params) => AuditCertificateWidget(),
        ),
        FFRoute(
          name: ProofOfBankDepositWidget.routeName,
          path: ProofOfBankDepositWidget.routePath,
          builder: (context, params) => ProofOfBankDepositWidget(),
        ),
        FFRoute(
          name: ViewUserDocumentsWidget.routeName,
          path: ViewUserDocumentsWidget.routePath,
          requireAuth: true,
          builder: (context, params) => ViewUserDocumentsWidget(
            userClaimData: params.getParam(
              'userClaimData',
              ParamType.JSON,
            ),
          ),
        ...
        FFRoute(
          name: ViewUserDocWidget.routeName,
          path: ViewUserDocWidget.routePath,
          builder: (context, params) => ViewUserDocWidget(
            formType: params.getParam(
              'formType',
              ParamType.String,
            ),
          ),
